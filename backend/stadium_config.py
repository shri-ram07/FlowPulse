...
from backend.core.zone import Edge, Zone


def default_stadium() -> list[Zone]:
    def z(id_: str, name: str, kind: str, cap: int, x: float, y: float,
          neigh: list[tuple[str, int]]) -> Zone:
        return Zone(
            id=id_, name=name, kind=kind, capacity=cap, x=x, y=y,
    ...
    zones = [
        ...
        # --- EXIT ramp ---------------------------------------------------
        z("exit_ramp", "Exit Ramp", "exit", 2000, 500, 855,
          [("con_s", 25), ("gate_f", 20)]),

        # --- CONCOURSES (4 cardinal rings) -------------------------------
        z("con_n", "North Concourse", "concourse", 3000, 500, 250,
          [("gate_a", 40), ("gate_b", 30), ("gate_c", 30), ("gate_d", 40),
           ("food_1", 25), ("food_2", 25), ("con_w", 60), ("con_e", 60),
           ("seat_n", 20)]),
        z("con_s", "South Concourse", "concourse", 3000, 500, 750,
          [("gate_e", 40), ("gate_f", 30), ("gate_g", 40),
           ("food_5", 25), ("food_6", 25), ("con_w", 60), ("con_e", 60),
           ("seat_s", 20), ("exit_ramp", 25)]),
        z("con_w", "West Concourse", "concourse", 2500, 125, 500,
          [("con_n", 60), ("con_s", 60),
           ("food_3", 25), ("rest_1", 20), ("rest_2", 20), ("rest_3", 20),
           ("seat_w", 20)]),
        z("con_e", "East Concourse", "concourse", 2500, 875, 500,
          [("con_n", 60), ("con_s", 60),
           ("food_4", 25), ("rest_4", 20), ("rest_5", 20), ("rest_6", 20),
           ("seat_e", 20), ("merch_1", 30)]),
