      ...
      <section className="panel">
        ...
        {!location ? (
          <div className="info-banner" style={{ marginBottom: 10 }}>
            ...
            <span>
              Click any zone on the map so the concierge can give you a walking route. Without a
              location it can still answer general questions like "which food court is calmest?".
            </span>
          </div>
        ) : (
          <div className="info-banner" style={{ marginBottom: 10 }}>
            <span aria-hidden>✅</span>
            <span>
              Location set to <b>{locName}</b>. Every recommendation now includes a walking time via
              the <code>get_best_route</code> tool.{" "}
              <button
