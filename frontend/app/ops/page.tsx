      ...
      <main className="welcome" style={{ maxWidth: 440, paddingTop: 48 }}>
        <form className="panel" onSubmit={doLogin}>
          ...
          <p className="meta" style={{ marginBottom: 14 }}>
            Demo credentials: <span className="kbd">ops</span> /{" "}
            <span className="kbd">ops-demo</span>
          </p>
          ...
          />
          <label htmlFor="p" style={{ marginTop: 10 }}>
            Password
          </label>
          <input
            id="p"
      ...
      <section className="panel">
        ...
        {alerts.length > 0 && (
          <div className="alert-banner" role="alert">
            ...
            <span>
              <b>{alerts.length}</b> new alert(s) — latest: {alerts[0].message}
            </span>
          </div>
        )}
