...
interface Msg {
  role: "user" | "bot";
  text: string;
  tools?: AttendeeReply["tool_calls"];
  engine?: string;
}
    ...
    <div className="panel" style={{ flex: 1 }}>
      <div className="panel-head">
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
          <span
            ...
            title="Every answer is grounded in a tool call shown as a chip"
          >
            Grounded AI
          </span>
          <button
          ...
          <div key={i} className={`msg ${m.role}`}>
            ...
            {m.tools && m.tools.length > 0 && (
              <div style={{ marginTop: 6 }}>
                ...
                {m.engine && (
                  <span className="tool-chip" title="Reasoning engine">
                    engine: {m.engine}
                  </span>
                )}
              </div>
      ...
      >
        ...
        <input
          ...
          placeholder="Ask about food, restrooms, routes…"
          disabled={busy}
          autoComplete="off"
