export type ZoneKind =
  | "gate" | "seating" | "food" | "restroom" | "concourse" | "exit" | "merch";
...
export interface GraphNode { id: string; name: string; kind: ZoneKind; x: number; y: number; }
export interface GraphEdge { from: string; to: string; walk_seconds: number; }
